...
namespace com.vdm.form
{
    public partial class frmFamerList : UIPage
    {
        ...
        {
            DataTable dt = this.famerBLL.getAllFamer(this.condition);
            ExcelUtil excelUtil = new ExcelUtil(this.dgFamerList, dt);
            frmExportExcel ef = new frmExportExcel(excelUtil, Data_Object_Const.FAMER);
            ef.ShowDialog();
        ...
        {
            frmImportExcelFile importExcelFile = new frmImportExcelFile(Data_Object_Const.FAMER);
