...
namespace com.vdm.form
{
    public partial class frmPeopleList : UIPage
    {
        ...
        {
            DataTable dt = this.peopleBLL.getAllPeopleDT(this.condition);
            ExcelUtil excelUtil = new ExcelUtil(this.dgPeopleList, dt);
        ...
        {
            frmImportExcelFile importExcelFile = new frmImportExcelFile(Data_Object_Const.PEOPLE);
