...
namespace com.vdm.dal
{
    public class FamerDAL : BaseDAL
    {
        ...
        public int getTotalCount(Hashtable condition)
        {
            ...
            DataTable dt = queryAllFamerCommon(condition, -1, -1);
            if (dt != null)
            {
        ...
        {
            return queryAllFamerCommon(condition, pageIndex, pageSize);
        }
        ...
        {
         return   queryAllFamerCommon(condition, -1, -1);
        }
        /// <summary>
        /// 创建农户
        /// </summary>
        ...
        public DataTable queryAllFamerCommon(Hashtable condition, int pageIndex, int pageSize)
        {
